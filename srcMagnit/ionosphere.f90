  ...
  case(1) ! North writes header and data
     ...
     if (output_type == idl_type) then
        ...
        case(all_vars)
           ...
           write(iUnit, '(I5,a)') 28, ' eDiffuse E-Flux [W/m2]'
           write(iUnit, '(I5,a)') 29, ' Mono E-Flux [W/m2]'
           write(iUnit, '(I5,a)') 30, ' iDiffuse E-Flux [W/m2]'
           write(iUnit, '(I5,a)') 31, ' Bband E-Flux [W/m2]'
           write(iUnit, '(I5,a)') 32, ' eDiffuse Ave-E [keV]'
           write(iUnit, '(I5,a)') 33, ' Mono Ave-E [keV]'
           write(iUnit, '(I5,a)') 34, ' iDiffuse Ave-E [keV]'
           write(iUnit, '(I5,a)') 35, ' Bband Ave-E [keV]'
     ...
     elseif (output_type == tec_type) then
        ...
        elseif (variables == all_vars) then
           ...
           write(iUnit, *)  ' "eDiffuse E-Flux [W/m^2]","Mono E-Flux [W/m^2]"'
           write(iUnit, *)  ' "iDiffuse E-Flux [W/m^2]","BBand E-Flux [W/m^2]"'
           write(iUnit, *)  ' "eDiffuse Ave-E [W/m^2]","Mono Ave-E [W/m^2]"'
           write(iUnit, *)  ' "iDiffuse Ave-E [W/m^2]","BBand Ave-E [W/m^2]"'
        ...
        do j = 1, IONO_nPsi
           do i = 1, IONO_nTheta
              write(iUnit,fmt="(22(E13.5))")  &
                   ...
                   IONO_NORTH_dLat(i,j), &
                   IONO_NORTH_dLon(i,j), &
                   IONO_NORTH_DIFF_EFlux(i,j), IONO_NORTH_MONO_EFlux(i,j), &
                   IONO_NORTH_IDIF_EFlux(i,j), IONO_NORTH_BBND_EFlux(i,j), &
                   IONO_NORTH_DIFF_Ave_E(i,j), IONO_NORTH_MONO_Ave_E(i,j), &
                   IONO_NORTH_IDIF_Ave_E(i,j), IONO_NORTH_BBND_Ave_E(i,j)
           end do
        end do
        ...
        do j = 1, IONO_nPsi
           do i = 1, IONO_nTheta
              write(iUnit,fmt="(22(E13.5))")  &
                   ...
                   IONO_SOUTH_dLat(i,j), &
                   IONO_SOUTH_dLon(i,j), &
                   IONO_SOUTH_DIFF_EFlux(i,j), IONO_SOUTH_MONO_EFlux(i,j), &
                   IONO_SOUTH_IDIF_EFlux(i,j), IONO_SOUTH_BBND_EFlux(i,j), &
                   IONO_SOUTH_DIFF_Ave_E(i,j), IONO_SOUTH_MONO_Ave_E(i,j), &
                   IONO_SOUTH_IDIF_Ave_E(i,j), IONO_SOUTH_BBND_Ave_E(i,j)
           end do
        end do
